...
#        sub_account_string: Optional[str] = None,
        ...
        :type api_secret: str.
        :param sub_account_string: Sub-account string
...
#        self.SUB_ACCOUNT_STRING = sub_account_string
    ...
    def _get_headers(self) -> Dict:
        headers = {
            ...
            'subAccountString': "test_test@test.com"
        }
        if self.API_KEY:
            assert self.API_KEY
        ...
        '''    
        if self.SUB_ACCOUNT_STRING:
            assert self.SUB_ACCOUNT_STRING
            headers['subAccountString'] = self.SUB_ACCOUNT_STRING
        '''
    ...
    def _create_margin_api_uri(self, path: str, version: str = "v1") -> str:
...
class Client(BaseClient):
    ...
    def _request_margin_api(self, method, path, signed=False, version: str = "v1", **kwargs) -> Dict:
    ...
    # Sub Accounts
    def create_broker_sub_account(self, **params):
        """Create Sub-account on Broker API.
        """
        return self._request_margin_api('post', 'broker/subAccount', signed=True, data=params)
    ...
    def get_sub_account_list(self, **params):
        ...
        """
        return self._request_margin_api('get', 'broker/subAccount', signed=True, data=params)
    ...
    def get_sub_account_assets(self, version="v1", **params):
        ...
        """
        return self._request_margin_api('get', 'sub-account/assets', True, version=version, data=params)
    ...
    def get_subaccount_deposit_address(self, **params):
        ...
        """
        return self._request_margin_api('get', 'capital/deposit/subAddress', signed=True, data=params)
    ...
    def enable_subaccount_futures(self, **params):
        ...
        """
        return self._request_margin_api('post', 'broker/subAccount/futures', True, data=params)
    ...
    def make_subaccount_universal_transfer(self, **params):
        ...
        """
        return self._request_margin_api('post', 'broker/universalTransfer', True, data=params)
...
class AsyncClient(BaseClient):
    ...
    async def _request_margin_api(self, method, path, signed=False, version="v1", **kwargs) -> Dict:
    ...
    async def get_sub_account_assets(self, version: str = "v1", **params):
        return await self._request_margin_api('get', 'sub-account/assets', True, version, data=params)
